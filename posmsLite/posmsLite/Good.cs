...
namespace posmsLite
{
    ...
    public class Good
    {
        ...
        private static string[] randMilk = { "Milk"}; 
        private static string[] randBakery = { "Bread"};
        private static string[] randHouseholdСhemicals = {"Domestos" };
        private static string[] randMeat = {"Pork" };
        private static string[] randFish = {"Salmon" };
        private static string[] randCereals = {"Cereals" };
        private static string[] randPasta = {"Instant noodles" };
        private static string[] randFruit = {"Apple" };
        private static string[] randVegetables = {"Tomato" };
        private static string[] randGrocery = { "Salt" };
